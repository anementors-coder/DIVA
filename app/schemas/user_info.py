...
from app.utils.api_utils import validate_linkedin_url
...
class UserInfoBase(BaseModel):
    ...
    onboarding_query: Dict[str, Any] = Field(..., description="A JSON object containing the user's answers to onboarding questions")
